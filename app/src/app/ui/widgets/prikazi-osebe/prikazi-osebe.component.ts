...
@Component({
  selector: 'app-prikazi-osebe',
  templateUrl: './prikazi-osebe.component.html',
  styleUrls: ['./prikazi-osebe.component.scss'],
  standalone: true
})
export class PrikaziOsebeComponent implements AfterViewInit {

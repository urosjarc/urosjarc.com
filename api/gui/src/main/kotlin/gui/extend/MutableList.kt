...
fun List<Anotacija>.vmesY(zgornja_meja: Double, spodnja_meja: Double): List<Anotacija> =
...
fun List<Anotacija>.najblizjiDesno(ano: Anotacija): Anotacija? = this.desno(meja = ano.x_max).maxByOrNull { it.x }
 ...
 */
fun List<Anotacija>?.najblizjaSpodnjaMeja(ano: Anotacija, default: Double): Double = this.najblizjaSpodnjaMeja(meja = ano.y_max, default = default)
fun List<Anotacija>?.najblizjaZgornjaMeja(ano: Anotacija, default: Double): Double = this.najblizjaZgornjaMeja(meja = ano.y, default = default)
fun List<Anotacija>?.najblizjaLevaMeja(ano: Anotacija, default: Double): Double = this.najblizjaLevaMeja(meja = ano.x, default = default)
fun List<Anotacija>?.najblizjaDesnaMeja(ano: Anotacija, default: Double): Double = this.najblizjaDesnaMeja(meja = ano.x_max, default = default)
